...
def draw_menu():
    ...
    global game_over, pause, mode, level, menu, time_passed, total_shots, points, ammo, time_remaining, best_freeplay, best_ammo, best_timed, write_values, clicked, new_coords 
